    ...
    with TelegramClient("Geogramint", api_id, api_hash, device_model="A320MH", app_version="2.1.4a",
        ...
        if pictures:
            with Progress() as progress:
                _download_profile_pictures(
                    progress, ListofUser, ListofGroup, client
                )
    return ListofUser, ListofGroup, dt_string


# TODO Rename this here and in `geolocate_AllEntities_Nearby`
def _download_profile_pictures(progress, ListofUser, ListofGroup, client):
